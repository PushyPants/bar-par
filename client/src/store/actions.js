...
export const getEmployeeList = () => {
  return dispatch => {
    API.getEmployee()
      .then(res => dispatch(sendAllEmployeesToStore(res.data)))
      .catch(err => console.log(err.response));
  };
};
...
export const updateEmployee = (empId, postId) => {
  return dispatch => {
    API.updateEmployeeAvail(empId, { avail: postId })
      .then(res => API.deleteAvailability(postId))
      .then(res => dispatch(getEmployeeList()))
      .catch(err => console.log(err));
  };
};
...
export const getLocation = () => {
  return dispatch => {
    API.getLocations()
      .then(res => dispatch(sendAllLocationsToStore(res.data)))
      .catch(err => console.log(err.response));
  };
};
