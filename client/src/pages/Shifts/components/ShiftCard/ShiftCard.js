    ...
    if (Employee) {
      for (let i = 0; i < Employee.avail.length; i++) {
        if (this.props.dayOfWeek === Employee.avail[i].dayOfWeek) {
          if (
            this.state.shiftStart > Employee.avail[i].availEnd ||
      ...
      () => {
        for (let i = 0; i < this.props.employeeList.length; i++) {
          for (let j = 0; j < this.props.employeeList[i].avail.length; j++) {
            if (
              this.props.dayOfWeek ===
              this.props.employeeList[i].avail[j].dayOfWeek
            ) {
              if (
                this.state.shiftStart > this.endAvail(i, j) ||
            ...
            <React.Fragment>
              <Grid item xs={6}>
                <EmployeeDrop
                  ...
                  Employee={
                    this.state.Employee ? this.state.Employee : "default"
                  }
